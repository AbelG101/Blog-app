...
RSpec.feature "Users", type: :feature do
  before(:each) do
    ...
    # Comment.create(post: @last_post, author: @user, text: 'This is the 1st comment on the last post')
    # Comment.create(post: @last_post, author: @user, text: 'This is the 2st comment on the last post')
    # Comment.create(post: @last_post, author: @user, text: 'This is the 3st comment on the last post')
  end
